@extends('layouts.app')
@section('title', 'Jenis Pemasukan Bank')
@section('subtitle', 'Kelola kategori pemasukan saldo bank Anda — berlaku untuk semua akun bank')

@section('content')
<div x-data="typeApp('/api/bank/income-types')" x-init="load()">

    <div class="mb-5 p-4 bg-blue-50 border border-blue-200 rounded-xl text-sm text-blue-700 flex items-start gap-2">
        ...
        <span>Jenis pemasukan yang dibuat di sini berlaku untuk <strong>semua akun bank</strong> Anda (BCA, BRI, BNI, dll). Anda tidak perlu membuat ulang untuk setiap akun.</span>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div x-show="!loading && items.length===0" class="flex flex-col items-center py-16 text-slate-400">
            ...
            <p class="text-sm font-medium">Belum ada jenis pemasukan bank</p>
            <p class="text-xs mt-1">Contoh: Gaji, Transfer Keluarga, Bonus</p>
        </div>
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md"
            ...
            <div class="px-6 py-5 space-y-4">
                <div>
                    ...
                    <input type="text" x-model="form.name" placeholder="Contoh: Gaji, Transfer Keluarga, Bonus, Dividen"
