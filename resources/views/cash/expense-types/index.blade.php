@extends('layouts.app')
@section('title', 'Jenis Pengeluaran Cash')
@section('subtitle', 'Kelola kategori pengeluaran uang tunai Anda')

@section('content')
{{-- Konten identik dengan cash/income-types/index.blade.php --}}
{{-- Ganti: typeApp('/api/cash/income-types') → typeApp('/api/cash/expense-types') --}}
{{-- Ganti semua label "Pemasukan" → "Pengeluaran" --}}
{{-- Ganti warna icon: bg-emerald-100/text-emerald-600 → bg-rose-100/text-rose-600 --}}
<div x-data="typeApp('/api/cash/expense-types')" x-init="load()">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div x-show="!loading && items.length===0" class="flex flex-col items-center py-16 text-slate-400">
            ...
            <p class="text-sm font-medium">Belum ada jenis pengeluaran</p>
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md"
            ...
            <div class="px-6 py-5 space-y-4">
                <div>
                    ...
                    <input type="text" x-model="form.name" placeholder="Contoh: Kebutuhan Harian, Transportasi, Makan"
